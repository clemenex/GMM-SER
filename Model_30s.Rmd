...
# Load the data
df <- read_csv("data/daic_prosodic_summary_30s.csv") %>%
  mutate(
...
# 📌 **Bayesian Model: Pitch Variation**
...
# 📌 **Top Participants by Pitch Variation**
...
# 📌 **Optional: Bayesian Model for Energy Variation**
